...
2. **Collision-report value measurement**: story-066 carries sprint overlap into the release review (§6) rather than buying another story round — keep it only if that reader uses the signal (testimony conflicted; artifacts silent).
