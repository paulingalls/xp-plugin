...
The bundle's `Close-review depth` section states the effective depth and plan-review
provenance: `deep` spends most effort on checks 1–2 at full depth; `standard` weights 1, 3–5.
